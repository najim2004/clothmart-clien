...
const Catagories = () => {
  return (
    <Section className="mt-10">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-h-[450px]">
        <div className="group relative overflow-hidden">
          <img src={bestSel1} alt="" />
          <div className="absolute flex flex-col items-center w-full group-hover:-translate-y-[50px] translate-y-full bottom-0 duration-700">
